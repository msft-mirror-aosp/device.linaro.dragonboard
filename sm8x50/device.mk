...
ifeq ($(TARGET_KERNEL_USE), mainline)
	FSTAB_NAME = fstab-mainline
else
	FSTAB_NAME = fstab
endif
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/$(FSTAB_NAME):$(TARGET_COPY_OUT_RAMDISK)/first_stage_ramdisk/fstab.sm8x50 \
    $(LOCAL_PATH)/$(FSTAB_NAME):$(TARGET_COPY_OUT_VENDOR)/etc/fstab.sm8x50
endif
